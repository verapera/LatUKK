...
<head>
  ...
  <title>MagooKasir | @yield('title')</title>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <aside class="left-sidebar">
      ...
      <div>
          ...
          <div class="row">
            <div class="col mt-3">
              <a href="/" class="text-nowrap logo-img ">
                <img src="/assets/images/logos/favicon.png" width="30" alt="" />
              </a>
            </div>
            <div class="col mt-2">
              <h2 class="fw-semibold">MagooKasir</h2>
            </div>
          </div>
        ...
        <!-- Sidebar navigation-->
        <nav class="sidebar-nav scroll-sidebar shadow" data-simplebar="">
          <ul id="sidebarnav">
